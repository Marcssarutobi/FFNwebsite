    ...
    <section class="page-title" style="background-image:url(/assets/images/background/imagesMenu.jpeg);">
    	<div class="auto-container">
        	<div class="sec-title">
                ...
                <div class="bread-crumb"><RouterLink to="/">Home</RouterLink>  / <a href="#">FIELD </a> / <a href="#" class="current">EduMyco</a></div>
            </div>
        </div>
    </section>
                        ...
                        <div class="column default-featured-column">
                            <article class="inner-box">
                                <figure class="image-boxs">
                                    <img src="/assets/images/resource/edu.png" alt="">
                                </figure>
                                <div class="content-box padd-top-40">
                                    <div class="row detail-header clearfix">
                                        <div class="col-md-12 ">
                                            <h2>Fungal Education, Awareness, and Valorization (EduMyco)</h2>
                                        </div>
                                    ...
                                    <div class="text" style="text-align: justify !important;" >
                                        EduMyco is responsible for spreading knowledge about fungi to diverse audiences, including students, decision-makers, rural communities, and the general public.
                                        It organizes workshops, training sessions, exhibitions, scientific events (such as Benin Fungus Day), and produces educational materials and popular science publications.
                                        The unit also highlights the traditional, nutritional, medicinal, and cultural uses of fungi while promoting environmentally responsible fungal practices.
