<template>
    ...
    <section class="page-title" style="background-image:url(/assets/images/background/page-title-bg.jpg);">
    	<div class="auto-container">
        	<div class="sec-title">
                <h1>Events</h1>
                <div class="bread-crumb"><a href="index.html">Home</a> / <a href="#" class="current">Events</a></div>
            </div>
        </div>
    </section>
    	...
    	<div class="auto-container">
        	...
        	<div class="row clearfix">
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<router-link to="/eventsingle"><img src="/assets/images/resource/featured-image-24.jpg" alt=""></router-link>
                            <div class="post-tag">Featured</div>
                        </figure>
                        <div class="content-box">
                        	<h3><router-link to="/eventsingle">One Tree Thousand Hope</router-link></h3>
                            ...
                            <router-link to="/eventsingle" class="theme-btn btn-style-three">Read More</router-link>
                        </div>
                    </article>
                </div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-25.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-26.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-27.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-28.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-29.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-30.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
                ...
                <div class="column default-featured-column style-two col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/featured-image-31.jpg" alt=""></a>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">One Tree Thousand Hope</a></h3>
                            <div class="column-info">13-14 Feb in Sanfransico, CA</div>
