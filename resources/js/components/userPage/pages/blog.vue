    	...
    	<div class="auto-container">
        	...
        	<div class="row clearfix">
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<router-link to="/blogsingle"><img src="/assets/images/resource/blog-image-1.jpg" alt=""></router-link>
                            <div class="news-date">28<span class="month">OCT</span></div>
                        </figure>
                        <div class="content-box">
                        	<h3><router-link to="/blogsingle">Melting ice</router-link></h3>
                            ...
                            <router-link to="/blogsingle" class="theme-btn btn-style-three">Read More</router-link>
                        </div>
                    </article>
                </div>
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/blog-image-11.jpg" alt=""></a>
                            <div class="news-date">28<span class="month">OCT</span></div>
                        </figure>
                        <div class="content-box">
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/blog-image-12.jpg" alt=""></a>
                            <div class="news-date">22<span class="month">APR</span></div>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">Deforestation is the threat</a></h3>
                ...
                <div class="column blog-news-column col-lg-4 col-md-6 col-sm-6 col-xs-12">
                	<article class="inner-box">
                		<figure class="image-box">
                        	<a href="#"><img src="/assets/images/resource/blog-image-13.jpg" alt=""></a>
                            <div class="news-date">23<span class="month">MAR</span></div>
                        </figure>
                        <div class="content-box">
                        	<h3><a href="#">Save the animals</a></h3>
